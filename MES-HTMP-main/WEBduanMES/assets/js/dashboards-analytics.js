...
(function () {
 ...
 orderChartConfig = {
   ...
   labels: ['Chạy', 'Dừng', 'Tắt', 'Hoàn thành chương trình'],
   series: [85, 15, 50, 50],
   colors: [config.colors.success,config.colors.warning, config.colors.primary, config.colors.info],
   stroke: {
     width: 5,
     colors: cardColor
   },
...
const chartOrderStatistics2 = document.querySelector('#dothi'),
orderChartConfig2 = {
  chart: {
    height: 165,
    width: 130,
  ...
  labels: ['Chạy', 'Gặp trục trặc', 'Tắt', 'Hoàn thành chương trình'],
  series: [85, 15, 50, 50],
  colors: [config.colors.success,config.colors.warning, config.colors.primary, config.colors.info],
  stroke: {
    width: 5,
